...
<body>
	...
	<div style="height: auto;background-color: white;">
		...
		<!--上面第3个大div-->
		<form id='formname' class="form-horizontal" role="form"
			action="./RegisterServlet" method="post">
			<h3 id="title">请填写注册信息</h3>
			<!-- 用户名 -->
			<div class="form-group">
				...
				<span class="col-sm-4" id='tips'>6-30位字母、数字或“_”,字母开头</span>
			</div>
			<!-- 密码 -->
			<div class="form-group">
				<label class="col-sm-4 control-label"><span
				...
				<div class="col-sm-4">
					<input class="form-control" id="inputPassword1" name="password"
						type="password" placeholder="6-20位的数字、字母或符号">
				</div>
			</div>
			<!-- 密码2 -->
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label"><span
					class="item_tips">* </span>证件号码</label>
				<div class="col-sm-4">
					<input class="form-control" id="DocumentNumber" name="idnumber"
						type="text" value="" placeholder="请输入您的证件号码">
				</div>
				<span class="col-sm-4" id='tips'>用于身份核验，请正确填写</span>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" id="inputEmail" name="email"
						type="mail" value="" placeholder="请正确填写邮箱地址">
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-4 control-label"><span
					class="item_tips">* </span>手机号码（+86）</label>
				<div class="col-sm-4">
					<input class="form-control" id="inputPhoneNumber"
						name="phonenumber" type="text" value="" placeholder="请输入您的手机号码">
				</div>
				<span class="col-sm-4" id='tips'>请正确填写手机号码，稍后将向该手机号码发送短信验证码</span>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<a href="">《中国铁路客户服务中心网站服务条款》 </a> <a href="">《隐私权政策》</a>
				</div>
			</div>

			<div id="buttons">
				<button type="submit" class="btn btn-md" id='nextStepButton'
					style="width: 30%;">注册</button>
			</div>
	...
	// 			alert(logininfo);
		...
		$('#nextStepButton').on(
				...
				function() {
					...
					if ((flag == 0) && (username.length < 6)
							&& (username.length > 30)) {
						flag = 1;
						alert('错误！用户名需填写6-30位！');
						return false;
					...
					if ((flag == 0) && (userpassword1 != userpassword2)) {
						...
						if (!patrn.test(userpassword1)) {
							flag = 1;
							alert('密码无效！请填写6-20位的数字、字母或符号！');
							return false;
						}
					}
					console.log(inputphonenumber);
					console.log(!(/^1[3456789]\d{9}$/.test(inputphonenumber)));
					if (!(/^1[3456789]\d{9}$/.test(inputphonenumber))) {
						flag = 1;
						alert("手机号码有误!请重新填写!");
						return false;
					}
