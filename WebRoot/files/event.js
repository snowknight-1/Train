TouClick.ready(function () {
	...
	for (var i = 0; i < targetelement.length; i++) {
		...
		var $targetdiv = $('#' + targetdiv[i]), code_type = $targetdiv.data("code_type"), touclick_type = $targetdiv.data("touclick-type");
	...
	$('.captchaFloatButton').each(function (i, v) {
		...
		var that = $(this), isbut = false, istou = false, timeoutHandle, timeout = false,touclick_name = that.data("touclick-name");
		...
		leftTicketOrderNote.text(login_messages["leftTicketOrderNoteMessage"]).css({"fontSize":"14px","display":"inline-block","position":"absolute","width":"220px","fontWeight":"bold"});
