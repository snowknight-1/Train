...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link rel="shortcut icon" href="https://www.12306.cn/index/images/favicon.ico" type="image/x-icon" />
	...
	<body>
		<div style="height: auto;background-color: white;">
			...
			<div class="wrapper content">
				...
				当前位置：<a href="./index.html">个人中心</a><span class="sep">&nbsp;&nbsp;>&nbsp;&nbsp;</span><span class="active" style="color:#3B99FC;">火车票订单</span>
				</div>
			</div>
			...
			<div class="center-box">
				<ul class="center-menu">
				    ...
				    <li class="menu-item">
				      ...
				      <ul class="menu-sub">
				        <li id="chepiaodingdan"><a href="./train_order.html"  style="color:#3B99FC;">火车票订单</a></li>
				        <li id="houbudingdan"><a href="./lineUp_order.html">候补订单</a></li>
				        <li>
				        	<a name="g_href" data-type="10" data-href="queryMyOrder.html" data-redirect="Y" href="javascript:;">餐饮•特产</a>
						</li>
				        <li id="baoxiandingdan"><a href="./my_insurance.html">保险订单</a></li>
				      </ul>
				    </li>
				    <li id="gerenxingcheng" class="menu-item">
				      <h2 class="menu-tit"><a href="./personal_travel.html">本人车票</a></h2>
				    </li>
				    <li class="menu-item">
				      <h2 class="menu-tit"><a name="g_href" data-type="3" data-href="welcome.html" data-redirect="Y" href="javascript:;">会员中心</a></h2>
				    </li>
				    <li class="menu-item">
				    ...
				    <li class="menu-item">
				      <h2 class="menu-tit">常用信息管理<i class="icon icon-switch"></i></h2>
				      <ul class="menu-sub">
				    ...
				    <li class="menu-item">
				      <h2 class="menu-tit">温馨服务<i class="icon icon-switch"></i></h2>
				      <ul class="menu-sub">
				        <li id="lvkeyuyue"><a href="./icentre_qxyyInfo.html">重点旅客预约</a></li>
				        <li id="yishiwupin"><a href="./icentre_lostInfo.html">遗失物品查找</a></li>
				        <li id="J-icentre_serviceQuery"><a href="./icentre_serviceQuery.html">服务查询</a></li>
				      </ul>
				    </li>
				    <li class="menu-item">
				        <h2 class="menu-tit">投诉和建议<i class="icon icon-switch"></i></h2>
				        <ul class="menu-sub">
				            <li id="J-advice_complaintInfo"><a href="./advice_complaintInfo.html">投诉</a></li>
				            <li id="J-advice_adviceInfo"><a href="./advice_adviceInfo.html">建议</a></li>
				        </ul>
				    </li>
				</ul>
			<!-- 个人中心右侧 -->
						...
						<div class="panel-tab">
							<div class="tab-hd">
								<ul class="tab-hd-list" id="order_tab">
									<li data-type="0"><a href="search.jsp">未完成订单
											
										</a></li>
									<li class="active"><a href="javascript:;">未出行订单
...
// 	                                        	System.out.println(userid);
												...
												String get_order = "SELECT * FROM ticket_order WHERE user_id = ? AND order_state != 0 AND order_state != 1";
...
// 																System.out.println(rs_ticket.getInt("ticket_status"));
																String ticket_state = "";
																switch(rs_ticket.getInt("ticket_status")){
																	case 2:
																		ticket_state = "未出行";
																		break;
																	case 3:
																...
																out.println("<td style='width: 150px'>");
																out.println("<div>"+ticket_state+"</div></td>");
																
																out.println("<td>");
																if(rs_ticket.getInt("ticket_status") == 2)
																	out.println("<div><a href='#'>改签</a><a href=changeOrderServlet?ticket_id="+rs_ticket.getString("id")+">退票</a></td></tr>");
																else if(rs_ticket.getInt("ticket_status") == 3)
																	out.println("<div><a href=changeOrderServlet?ticket_id="+rs_ticket.getString("id")+">退票</a></td></tr>");
																else if(rs_ticket.getInt("ticket_status") == 4)
																	out.println("<div><a href='#'>无法操作</a></td></tr>");
															}
										...
										<div class="tips-box mt-lg duo-tips" style="display: none">
											<h4 class="tips-tit ">温馨提示</h4>
											<p>1.订单信息在本网站保存期限为30日。</p>
											<p>2.在本网站购票后，没有换取纸质车票的，可不晚于开车前25分钟在本网站办理改签、退票业务，或不晚于开车前48小时在本网站办理“变更到站”业务。</p>
...
// 							alert(user_name);
	...
	<%
		if(session.getAttribute("change_status")!=null){
			%>
