						...
						<div class="panel-tab">
							<div class="tab-hd">
								<ul class="tab-hd-list" id="order_tab">
									...
									<li data-type="1"><a href="search_2.jsp">未出行订单
									...
									<div class="order-panel order-panel-history">
										...
										<div id="history_travel">
											<%
												...
												String get_order = "SELECT * FROM ticket_order WHERE user_id = ?";
													...
													while (rs.next()) {
														...
														if(rs_ticket != null) {
															...
															while (rs_ticket.next()) {
																...
																out.println("<td class='order-left align-top' rowspan='1' style='width: 240px'>");
																...
																out.println("<td style='width: 240px'>");
																...
																out.println("<td>");
																out.println("<div>"+ticket_state+"</div></td></tr>");
															}
										...
										<div id="J-History" class="pagination mt-lg">
	                                    </div>
