...
<link href="css/iconfont3.css" rel="stylesheet">
...
<body>
					...
					<table class="table table-bordered agileinfo">
						...
						<c:forEach var="row" items="${messageList}" varStatus="status">
							<tr>
								...
								<td class="t14"><c:out value="${row.wuzuo}" /><br> <br>
									<c:out value="${row.wuzuop}" />
								</td>
								<td class="t15"><a href="#" data-toggle="modal"
									data-target="#myModalbook" class="seat-button two">预订</a>
								</td>
							</tr>
						</c:forEach>
					</table>
	...
	<div style="height: 340px;background-color: white;">
		<div
			...
			<div style="width: 590px;height: 160px;float: left;margin-top: 20px;">
	...
	<div style="height: 365px;background-color: white;">
		<div
			...
			<!--下面的div-->
			<div style="border: 1px gainsboro solid;width: 1190px;height: 260px;">
				<!--左侧div-->
				<div
